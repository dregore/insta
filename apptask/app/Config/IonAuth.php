...
class IonAuth extends \IonAuth\Config\IonAuth
{
	 ...
	 */
	public $siteTitle                = 'Insta.grattomania.space';       // Site Title, example.com
	public $adminEmail               = 'support@grattomania.space'; // Admin Email, admin@example.com
	...
	public $userExtendonLogin        = true;               // Extend the users cookies every time they auto-login
